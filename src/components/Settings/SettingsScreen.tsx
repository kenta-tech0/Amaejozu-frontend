...
import { Bell, Mail, Smartphone, Heart, RefreshCw, User, LogOut, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="pb-4">
      ...
      <div className="px-6 pt-6 space-y-6">
        {/* Account Section */}
        <div>
          <h2 className="text-sm text-slate-600 dark:text-slate-400 mb-3">アカウント</h2>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
            <button className="w-full flex items-center gap-3 px-4 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              ...
              <span className="flex-1 text-left text-slate-900 dark:text-white">プロフィール</span>
              <ChevronRight className="w-5 h-5 text-slate-400" />
            </button>
            <div className="border-t border-slate-200 dark:border-slate-800" />
            <button className="w-full flex items-center gap-3 px-4 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              <LogOut className="w-5 h-5 text-slate-600 dark:text-slate-400" />
              <span className="flex-1 text-left text-slate-900 dark:text-white">ログアウト</span>
              <ChevronRight className="w-5 h-5 text-slate-400" />
            </button>
          </div>
        </div>
        ...
        <div>
          <h2 className="text-sm text-slate-600 dark:text-slate-400 mb-3">通知方法</h2>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-4">
              <div className="flex items-center gap-3">
                <Smartphone className="w-5 h-5 text-slate-600 dark:text-slate-400" />
                <div>
                  <p className="text-slate-900 dark:text-white">プッシュ通知</p>
        ...
        {/* Watchlist Section */}
        <div>
          <h2 className="text-sm text-slate-600 dark:text-slate-400 mb-3">ウォッチリスト</h2>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
        ...
        {/* Data Update Section */}
        <div>
          <h2 className="text-sm text-slate-600 dark:text-slate-400 mb-3">データ更新</h2>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
            <div className="px-4 py-4">
              <div className="flex items-center gap-3 mb-3">
        ...
        {/* About Section */}
        <div>
          <h2 className="text-sm text-slate-600 dark:text-slate-400 mb-3">その他</h2>
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
            <button className="w-full flex items-center gap-3 px-4 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              <span className="flex-1 text-left text-slate-900 dark:text-white">利用規約</span>
              <ChevronRight className="w-5 h-5 text-slate-400" />
            </button>
            <div className="border-t border-slate-200 dark:border-slate-800" />
            <button className="w-full flex items-center gap-3 px-4 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              <span className="flex-1 text-left text-slate-900 dark:text-white">プライバシーポリシー</span>
              <ChevronRight className="w-5 h-5 text-slate-400" />
            </button>
            <div className="border-t border-slate-200 dark:border-slate-800" />
            <button className="w-full flex items-center gap-3 px-4 py-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
              <span className="flex-1 text-left text-slate-900 dark:text-white">お問い合わせ</span>
              <ChevronRight className="w-5 h-5 text-slate-400" />
            </button>
            <div className="border-t border-slate-200 dark:border-slate-800" />
            <div className="px-4 py-4">
