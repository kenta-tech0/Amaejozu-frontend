  ...
  const pages = [
    {
      ...
      description:
        "Amazon、楽天市場など主要ECサイトの価格を毎日チェック。お気に入り商品が値下がりしたら即座に通知します。",
    ...
    },
    {
      ...
      description:
        "AIが価格推移や割引率を分析。今買うべき商品をランキング形式でお届けします。",
    ...
    },
    {
      ...
      title: "興味のあるジャンルを選択",
      description:
        "選択したジャンルの情報を優先的にお届けします。あとから変更することもできます。",
      bgColor: "bg-blue-500",
    },
  ];
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12">
        {currentPage < 2 ? (
          <div className="text-center">
            <div
              className={`inline-flex items-center justify-center w-32 h-32 ${pages[currentPage].bgColor} rounded-full mb-8`}
            >
          ...
          <div>
            <div className="text-center mb-8">
              <div
                className={`inline-flex items-center justify-center w-32 h-32 ${pages[2].bgColor} rounded-full mb-8`}
              >
                {pages[2].icon}
              </div>
              <h2 className="text-2xl text-slate-900 dark:text-white mb-4">
